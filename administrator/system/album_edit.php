<?
	...
	if($_POST['submit']){
		...
		if($pics1){
			...
			if($last_name1=="gif" or $last_name1=="jpg" or $last_name1=="jpeg" or $last_name1=="png"){
				if($_POST['picture1']!="default.jpg"){
					unlink("../public/food/album/".$_POST['picture1']);
				}
				copy($pics1, "../public/food/album/".$fir1.$_GET['idx'].".".$last_name1);
			}
			$p.="album_cover='".$fir1.$_GET['idx'].".".$last_name1."', ";			
		}
		
		mysql_query("update album set $p category_id='".$_GET['fid']."', album_title='".$_POST['album_title']."', album_short_description='".$_POST['album_short_description']."', album_status='".$_POST['status']."', album_updatedtime='".$today."', album_updatedip='".$_SERVER['REMOTE_ADDR']."' where album_id='".$_GET['idx']."'");
		...
		?><script> window.location='index.php?page=album&cid=<?=$_GET['cid']?>&fid=<?=$_GET['fid']?>'; </script><?
	}
?>
	...
	<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-edit"></i><span class="break"></span>แก้ไขรูปภาพ</h2>
						<!--<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="category" method="post" enctype="multipart/form-data">
							<fieldset><br>
								<? 
									$rs = mysql_query("select * from album where album_id='".$_GET['idx']."'");
								...
								<div class="controls">
								  <select id="category_id" name="category_id">
									<?
									$res = mysql_query("select * from  gallery_category where category_type='gallery' and category_status!='discard'");
							  ...
							  <div class="controls">
								<img src="../public/food/album/<?=$rw['album_cover']?>" height="300" width="300"><input type="hidden" name="picture2" id="picture2" value="<?=$rw['album_cover']?>">
							  </div>
							</div>
								<div class="control-group">
							  ...
							  <div class="form-actions">
								...
								<input type="button" class="btn btn-primary" value="ยกเลิก" onclick="window.location='index.php?page=album&cid=<?=$_GET['cid']?>&fid=<?=$_GET['fid']?>';">
							  </div>
							</fieldset>
						  </form>
