<?
	...
	if($_POST['submit']){
		...
		mysql_query("insert into news(news_title_en, news_title_th, news_sdesc_en, news_sdesc_th, news_desc_en, news_desc_th, news_status, news_createdip) values('".$news_title_en."', '".$news_title_th."', '".$news_sdesc_en."', '".$news_sdesc_th."', '".$news_desc_en."', '".$news_desc_th."', '".$_POST['news_status']."', '".$_SERVER['REMOTE_ADDR']."')");
		...
		if($pics1){
			...
			if($last_name1=="gif" or $last_name1=="jpg" or $last_name1=="jpeg" or $last_name1=="png"){
				copy($pics1, "../public/news/".$fir1.$id.".".$last_name1);
			}
