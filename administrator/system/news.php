						  ...
						  <tbody>
							...
							<tr>
								...
								<?
									...
									<td class="center"><img src="../public/news/thumb/<?=$row['news_tbm1']?>" width="50" height="50"></td>
								<? }?>
								...
								<td class="center">
									<a class="btn btn-success" href="#" onclick="window.location='index.php?page=news_album&nid=<?=$row['news_id']?>'">
										<i>album</i>  
									</a>
									<a class="btn btn-info" onclick="window.location='index.php?page=news_edit&idx=<?=$row['news_id']?>'">
