			...
			if($pics1){
				...
				if($last_name1=="gif" or $last_name1=="jpg" or $last_name1=="jpeg" or $last_name1=="png"){
					if($_POST['picture1']!="default.jpg"){
						unlink("../public/vdo/slide/".$_POST['picture1']);
					}
					copy($pics1, "../public/vdo/slide/s".$_GET['idx'].".".$last_name1);
				}
				...
				mysql_query("update `hslide` set $p url='".$_POST['url']."', youtube='".$_POST['youtube']."', type='".$_POST['type']."', status='".$_POST['status']."' where slide_id='".$_GET['idx']."'");
			}else{
				
				mysql_query("update `hslide` set url='".$_POST['url']."', youtube='".$_POST['youtube']."', type='".$_POST['type']."', status='".$_POST['status']."', pics='".$_POST['picture1']."' where slide_id='".$_GET['idx']."'");
...
<script>
	function changeoption(id){
		window.location='index.php?page=hslide_edit&idx=<?=$_GET['idx']?>&mid='+id;
	}
</script>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" name="menu" method="post" enctype="multipart/form-data">
							<fieldset>
								<?
									$rs = mysql_query("select * from hslide where hslide.slide_id='".$_GET['idx']."'");
							 ...
							 <div class="control-group">
							  ...
							  <div class="controls"><br>
								<img src="../public/vdo/slide/<?=$rw['pics']?>" height="225" width="200"><input type="hidden" name="picture1" id="picture1" value="<?=$rw['pics']?>">
							  </div>
							</div>
							<div class="control-group">
