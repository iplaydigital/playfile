...
<script>
	function del_row(id){
		if(confirm('Do you want to delete!!')==true){
			window.location = 'index.php?page=content&c=1&cid=<?=$_GET['cid']?>&idx='+id;
		}
	}
	function change_s(id, status){
		if(confirm('Do you want show or hide this content!!')==true){
			window.location = 'index.php?page=content&cid=<?=$_GET['cid']?>&ch=1&idx='+id+'&s='+status;
		}
	}
	...
	<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<div class="box-icon">
							<span class="break"><a href="#" class="btn-setting" onclick="window.location='index.php?page=content_add&cid=<?=$_GET['cid']?>';"><i class="icon-plus"></i>เพิ่มข้อมูล</a></span>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?
								$i=0;
								$res = mysql_query("select * from content where content_status!='discard' and category_id='0' order by content_id desc");
							...
							<tr>
								...
								<?
									...
									<td class="center"><img src="../public/content/<?=$row['content_thumbnail']?>" width="50" height="50"></td>
								<? }?>
								...
								<td class="center">
									...
									<a class="btn btn-info" onclick="window.location='index.php?page=content_edit&cid=<?=$row['content_id']?>&cid2=<?=$row['category_id']?>'">
