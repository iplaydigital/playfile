<?
	...
	if($_POST['submit']){
		...
		if($pics1){
			...
			if($last_name1=="gif" or $last_name1=="jpg" or $last_name1=="jpeg" or $last_name1=="png"){
				if($_POST['picture1']!="default.jpg"){
					unlink("../public/news/".$_POST['picture1']);
				}
				copy($pics1, "../public/news/".$fir1.$_GET['cid'].".".$last_name1);
			}
			$p.="news_tbm1='".$fir1.$_GET['cid'].".".$last_name1."', ";			
		}
		if($pics2){
			...
			if($last_name2=="gif" or $last_name2=="jpg" or $last_name2=="jpeg" or $last_name2=="png"){
				...
				copy($pics2, "../public/news/".$fir2.$_GET['cid'].".".$last_name2);
			}
			$p.="news_tbm2='".$fir2.$_GET['cid'].".".$last_name2."', ";			
		}
		if($pics3){
		...
		mysql_query("update news set $p news_title_en='".$news_title_en."', news_title_th='".$news_title_th."', news_sdesc_en='".$news_sdesc_en."', news_sdesc_th='".$news_sdesc_th."', news_desc_en='".$news_desc_en."', news_desc_th='".$news_desc_th."', news_status='".$_POST['news_status']."', news_updatedtime='".$today."', news_updatedip='".$_SERVER['REMOTE_ADDR']."' where news_id='".$_GET['cid']."'");
		...
		if($_POST['delete_pics']=="1"){
			...
			mysql_query("update news set news_tbm1='' where news_id='".$_GET['cid']."'");
		}
		...
		?><script> window.location='index.php?page=news&cid=<?=$_GET['cid2']?>'; </script><?
	}
?>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" name="content" method="post" enctype="multipart/form-data">
							<fieldset>
								<? 
									$rs = mysql_query("select * from news where news_id='".$_GET['cid']."'");
								...
								<label class="control-label" for="selectError3">หมวหมู่ :</label>
								<div class="controls">
								  <select id="category_id" name="category_id">
									<option value='' >เลือกหมวดหมู่</option>
									<?
									$res = mysql_query("select * from content_category where category_status!='discard'");
							  ...
							  <div class="controls">
								<? if($rw['news_tbm1']){?>
									<img src="../public/news/<?=$rw['news_tbm1']?>" height="225" width="300">
								<? }?>
							  </div>
							</div>
								<div class="control-group">
								  <label class="control-label" for="fileInput">รูปภาพ 1</label>
								  <div class="controls">
									<input class="input-file uniform_on" id="file1" name="file1" type="file"> (image size: 959px x 723px)
