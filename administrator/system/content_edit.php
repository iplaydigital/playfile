<?
	...
	if($_POST['submit']){
		...
		mysql_query("update content set $p category_id='0', content_url='".$content_url."', content_url2='".$content_url2."', content_title_en='".$content_title_en."', content_title_th='".$content_title_th."', content_sdesc_en='".$content_sdesc_en."', content_sdesc_th='".$content_sdesc_th."', content_desc_en='".$content_desc_en."', content_desc_th='".$content_desc_th."', content_status='".$_POST['content_status']."', content_updatedtime='".$today."', content_updatedip='".$_SERVER['REMOTE_ADDR']."' where content_id='".$_GET['cid']."'");
		//print "update content set $p category_id='".$_POST['category_id']."',  content_title_en='".$content_title_en."', content_title_th='".$content_title_th."', content_sdesc_en='".$content_sdesc_en."', content_sdesc_th='".$content_sdesc_th."', content_desc_en='".$content_desc_en."', content_desc_th='".$content_desc_th."', content_status='".$_POST['content_status']."', content_updatedtime='".$today."', content_updatedip='".$_SERVER['REMOTE_ADDR']."' where content_id='".$_GET['cid']."'";
		
		if($_POST['delete_pics']=="1"){
			if($_POST['picture1']!="default.jpg"){
				unlink("../public/content/".$_POST['picture1']);
			}
			mysql_query("update content set content_thumbnail='' where content_id='".$_GET['cid']."'");
		}
		
		?><script> window.location='index.php?page=content&cid=<?=$_GET['cid2']?>'; </script><?
	}
?>
	...
	<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="icon-edit"></i><span class="break"></span>แก้ไขบทความ</h2>
						<!--<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" name="content" method="post" enctype="multipart/form-data">
							<fieldset>
								<? 
									$rs = mysql_query("select * from content where content_id='".$_GET['cid']."'");
							  ...
							  <div class="controls">
								<? if($rw['content_thumbnail']){?>
									<img src="../public/content/<?=$rw['content_thumbnail']?>" height="225" width="300">
								<? }?>
							  </div>
							</div>
								<div class="control-group">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="content_title_th" name="content_title_th" rows="3"><?=$rw_title_th?></textarea>
							  </div>
							</div>
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">ชื่อบทความ (ไทย) :</label>
							  <div class="controls">
								<textarea class="cleditor" id="content_title_en" name="content_title_en" rows="3"><?=$rw_title_en?></textarea>
							  </div>
							</div>
							  <!--<div class="control-group">
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="content_url" name="content_url" rows="3"><?=$rw['content_url']?></textarea>
							  </div>
							</div> 
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">สถานที่ติดต่อ (En) :</label>
							  <div class="controls">
								<textarea class="cleditor" id="content_url2" name="content_url2" rows="3"><?=$rw['content_url2']?></textarea>
							  </div>
							</div> 
							  <div class="control-group">
							  ...
							  <div class="form-actions">
								...
								<input type="button" class="btn btn-primary" value="Cancel" onclick="window.location='index.php?page=content&cid=<?=$rw['category_id']?>';">
							  </div>
							</fieldset>
						  </form>
