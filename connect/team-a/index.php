...
//$data = $trello->request('GET', ('/boards/64940df4e7e843a39bdbc661'));
$data = $trello->request('GET', ('/boards/64940df4e7e843a39bdbc661/lists'));
//$data = $trello->request('GET', ('/boards/64940df4e7e843a39bdbc661/lists?name=Bang'));
//echo '<pre>';
//print_r($data);
//echo '</pre>';
//---------------//
